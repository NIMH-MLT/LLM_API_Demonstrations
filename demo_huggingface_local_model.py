...
## This demo mirrors demo_ollama_backend.py, but instead of talking to an Ollama
## server it loads a Hugging Face model from disk and runs inference locally.
...
# point at the local model folder (sibling of LLM_API_Demonstrations/)
model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'models', 'Qwen3.5-0.8B')
